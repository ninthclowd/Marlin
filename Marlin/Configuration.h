...
#define STRING_CONFIG_H_AUTHOR "(jcoleman, default config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  19.5
    #define DEFAULT_Ki   2.10
    #define DEFAULT_Kd  45.2
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 122.9
  #define DEFAULT_bedKi 22.60
  #define DEFAULT_bedKd 445.9
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.06, -38.35, 0 }
